...
--
-- Host: localhost    Database: ry-etp
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='交易记录';
...
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='羽毛球场预约表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `etp_attractions`
--

DROP TABLE IF EXISTS `etp_attractions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `etp_attractions` (
  `attractions_id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `attractions_name` varchar(100) NOT NULL COMMENT '景点名称',
  `location` varchar(100) DEFAULT NULL COMMENT '景点位置',
  `description` varchar(100) DEFAULT NULL COMMENT '景点描述',
  `ticket_price` decimal(10,0) NOT NULL COMMENT '景点票价',
  `image` varchar(100) DEFAULT NULL COMMENT '景点图片',
  PRIMARY KEY (`attractions_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='景点表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `etp_attractions`
--

LOCK TABLES `etp_attractions` WRITE;
/*!40000 ALTER TABLE `etp_attractions` DISABLE KEYS */;
INSERT INTO `etp_attractions` VALUES (1,'颐和园','北京','皇家园林',60,'/profile/upload/2024/04/26/IMG_20211205_121429_20240426211150A001.jpg'),(2,'圆明园','北京市海淀区','皇家园林',30,''),(3,'北海公园','北京市东城区','皇家园林',40,'');
/*!40000 ALTER TABLE `etp_attractions` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `etp_reservation`
--

DROP TABLE IF EXISTS `etp_reservation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `etp_reservation` (
  `reservation_id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `user_id` bigint NOT NULL COMMENT '用户ID',
  `attractions_id` bigint NOT NULL COMMENT '景点ID',
  `start_time` datetime DEFAULT NULL COMMENT '预约起始时间',
  `end_time` datetime DEFAULT NULL COMMENT '预约终止时间',
  `reservation_status` tinyint DEFAULT NULL COMMENT '预约状态，0预约，1取消',
  PRIMARY KEY (`reservation_id`)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='景点预约表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `etp_reservation`
--

LOCK TABLES `etp_reservation` WRITE;
/*!40000 ALTER TABLE `etp_reservation` DISABLE KEYS */;
INSERT INTO `etp_reservation` VALUES (26,1,1,'2024-04-28 09:00:00','2024-04-28 10:00:00',1),(27,1,1,'2024-04-28 09:00:00','2024-04-28 10:00:00',1),(28,1,1,'2024-04-28 10:00:00','2024-04-28 11:00:00',1),(29,1,1,'2024-04-28 09:00:00','2024-04-28 10:00:00',1),(30,1,1,'2024-04-28 13:00:00','2024-04-28 14:00:00',1),(31,1,1,'2024-04-28 15:00:00','2024-04-28 16:00:00',0),(32,1,2,'2024-04-29 09:00:00','2024-04-29 10:00:00',0),(33,102,1,'2024-04-29 13:00:00','2024-04-29 14:00:00',0),(34,102,2,'2024-04-30 17:00:00','2024-04-30 18:00:00',0),(35,103,2,'2024-04-30 14:00:00','2024-04-30 17:00:00',1),(36,103,2,'2024-04-30 09:00:00','2024-04-30 10:00:00',0),(37,103,1,'2024-04-30 15:00:00','2024-04-30 16:00:00',0),(38,102,3,'2024-04-30 15:00:00','2024-04-30 17:00:00',0);
/*!40000 ALTER TABLE `etp_reservation` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `etp_ticket`
--

DROP TABLE IF EXISTS `etp_ticket`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `etp_ticket` (
  `ticket_id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `user_id` bigint NOT NULL COMMENT '用户ID',
  `attractions_id` bigint NOT NULL COMMENT '场馆ID',
  `reservation_id` bigint NOT NULL COMMENT '预约ID',
  `ticket_type` tinyint DEFAULT NULL COMMENT '门票类型：0收入，1全价票，2优惠票',
  `ticket_status` tinyint DEFAULT NULL COMMENT '门票状态：0已购票，1已退票',
  `ticket_amount` decimal(7,2) DEFAULT NULL COMMENT '交易金额',
  `transaction_time` datetime DEFAULT NULL COMMENT '交易时间',
  `balance` decimal(7,2) DEFAULT NULL COMMENT '余额',
  PRIMARY KEY (`ticket_id`)
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='购票记录表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table
'admin','127.0.0.1','内网IP','Chrome 12','Windows 10','0','登录成功','2024-04-28 10:44:34'),(174,'admin','127.0.0.1','内网IP','Chrome 12','Windows 10','0','退出成功','2024-04-28 11:42:16'),(175,'zhaoliu','127.0.0.1','内网IP','Chrome 12','Windows 10','0','登录成功','2024-04-28 11:42:28'),(176,'zhaoliu','127.0.0.1','内网IP','Chrome 12','Windows 10','0','退出成功','2024-04-28 11:42:38'),(177,'admin','127.0.0.1','内网IP','Chrome 12','Windows 10','0','登录成功','2024-04-28 14:34:40'),(178,'admin','127.0.0.1','内网IP','Chrome 12','Windows 10','0','退出成功','2024-04-28 14:41:57'),(179,'wangwu','127.0.0.1','内网IP','Chrome 12','Windows 10','1','验证码错误','2024-04-28 14:42:08'),(180,'wangwu','127.0.0.1','内网IP','Chrome 12','Windows 10','0','登录成功','2024-04-28 14:45:02'),(181,'wangwu','127.0.0.1','内网IP','Chrome 12','Windows 10','0','退出成功','2024-04-28 14:46:40'),(182,'admin','127.0.0.1','内网IP','Chrome 12','Windows 10','0','登录成功','2024-04-28 14:46:46'),(183,'admin','127.0.0.1','内网IP','Chrome 12','Windows 10','0','退出成功','2024-04-28 15:07:23'),(184,'wangwu','127.0.0.1','内网IP','Chrome 12','Windows 10','0','登录成功','2024-04-28 15:07:41'),(185,'wangwu','127.0.0.1','内网IP','Chrome 12','Windows 10','0','退出成功','2024-04-28 15:30:35'),(186,'zhouqi','127.0.0.1','内网IP','Chrome 12','Windows 10','0','注册成功','2024-04-28 15:31:06'),(187,'admin','127.0.0.1','内网IP','Chrome 12','Windows 10','0','登录成功','2024-04-28 15:31:29'),(188,'admin','127.0.0.1','内网IP','Chrome 12','Windows 10','0','登录成功','2024-04-28 23:29:23'),(189,'admin','127.0.0.1','内网IP','Chrome 12','Windows 10','0','登录成功','2024-04-28 23:29:46'),(190,'admin','127.0.0.1','内网IP','Chrome 12','Windows 10','0','退出成功','2024-04-28 23:30:56'),(191,'admin','127.0.0.1','内网IP','Chrome 12','Windows 10','0','登录成功','2024-04-28 23:31:10'),(192,'admin','127.0.0.1','内网IP','Chrome 12','Windows 10','0','退出成功','2024-04-28 23:37:51'),(193,'zhaoliu','127.0.0.1','内网IP','Chrome 12','Windows 10','0','登录成功','2024-04-28 23:38:12'),(194,'zhaoliu','127.0.0.1','内网IP','Chrome 12','Windows 10','0','登录成功','2024-04-29 19:27:26'),(195,'zhaoliu','127.0.0.1','内网IP','Chrome 12','Windows 10','0','退出成功','2024-04-29 19:28:00'),(196,'zhaoliu','127.0.0.1','内网IP','Chrome 12','Windows 10','0','登录成功','2024-04-29 19:28:09'),(197,'zhaoliu','127.0.0.1','内网IP','Chrome 12','Windows 10','0','退出成功','2024-04-29 20:08:15'),(198,'wangwu','127.0.0.1','内网IP','Chrome 12','Windows 10','0','登录成功','2024-04-29 20:08:25'),(199,'wangwu','127.0.0.1','内网IP','Chrome 12','Windows 10','0','退出成功','2024-04-29 20:30:17'),(200,'admin','127.0.0.1','内网IP','Chrome 12','Windows 10','0','登录成功','2024-04-29 20:30:24'),(201,'admin','127.0.0.1','内网IP','Chrome 12','Windows 10','0','登录成功','2024-04-29 21:24:13'),(202,'admin','127.0.0.1','内网IP','Chrome 12','Windows 10','0','退出成功','2024-04-29 22:22:32'),(203,'wangwu','127.0.0.1','内网IP','Chrome 12','Windows 10','0','登录成功','2024-04-29 22:22:42'),(204,'wangwu','127.0.0.1','内网IP','Chrome 12','Windows 10','0','退出成功','2024-04-29 22:23:21'),(205,'admin','127.0.0.1','内网IP','Chrome 12','Windows 10','0','登录成功','2024-04-29 22:23:25');
...
INSERT INTO `sys_notice` VALUES (1,'欢迎大家预约','2',_binary '<p>羽毛球场馆开放啦，欢迎大家积极预约</p>','0','admin','2024-02-28 22:23:43','admin','2024-03-05 10:19:20','管理员'),(2,'景区电子门票预订管理系统维护','1',_binary '<p>系统维护中，两天后正常开放</p>','0','admin','2024-02-28 22:23:43','admin','2024-04-27 17:40:47','管理员');
...
) ENGINE=InnoDB AUTO_INCREMENT=217 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_role` VALUES (1,'超级管理员','admin',1,'1',1,1,'0','0','admin','2024-02-28 22:23:42','',NULL,'超级管理员'),(2,'教练员','coach',2,'2',0,1,'0','2','admin','2024-02-28 22:23:42','admin','2024-03-10 11:34:44','教练员'),(100,'优惠用户','VIP',3,'1',0,1,'0','0','admin','2024-02-28 22:41:12','admin','2024-04-29 22:21:40','老年人，儿童等可以优惠购票用户身份'),(101,'普通用户','common',4,'1',0,1,'0','0','admin','2024-02-28 22:41:32','admin','2024-04-29 22:21:33','普通用户');
...
INSERT INTO `sys_role_menu` VALUES (100,1035),(100,2031),(100,2032),(100,2033),(100,2034),(100,2036),(100,2037),(100,2040),(100,2041),(100,2042),(101,1035),(101,2031),(101,2032),(101,2033),(101,2034),(101,2036),(101,2037),(101,2040),(101,2041),(101,2042);
...
CREATE TABLE `sys_user` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `remark` varchar(500) DEFAULT NULL COMMENT '备注',
  `balance` decimal(7,2) DEFAULT '200.00' COMMENT '余额',
  PRIMARY KEY (`user_id`)
...
INSERT INTO `sys_user` VALUES (1,100,'admin','管理员','00','ry@163.com','15888888888','1','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','0','0','127.0.0.1','2024-04-29 22:23:26','admin','2024-02-28 22:23:42','','2024-04-29 22:23:25','管理员',578.20),(2,105,'ry','若依','00','ry@qq.com','15666666666','1','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','0','2','127.0.0.1','2024-02-28 22:23:42','admin','2024-02-28 22:23:42','',NULL,'测试员',NULL),(100,100,'zhangsan','张三','00','','13089876578','0','','$2a$10$g86PdbK5Z28hgOkGfevFCuO0KekkjR6OJdAHt8gCyLJFG3Uos.3JO','0','2','',NULL,'admin','2024-03-04 18:58:34','admin','2024-03-08 10:19:23',NULL,10.00),(101,100,'lisi','李四','00','','13909879876','0','','$2a$10$aiYx9RhkHXWto9AK.rMgu.MobzG6j76WtZ5jetHTmi67xJjcZ9tZq','0','2','',NULL,'admin','2024-03-04 18:58:57','admin','2024-03-08 10:19:28',NULL,10.00),(102,100,'wangwu','王五','00','','13809897654','1','','$2a$10$fvHIaJ0kOyCPYIFlo6Tnn.juTWodmgWP6IT/9D6qzI77zT6hhLNGS','0','0','127.0.0.1','2024-04-29 22:22:42','admin','2024-03-04 18:59:22','admin','2024-04-29 22:22:42',NULL,9556.80),(103,100,'zhaoliu','赵六','00','','13098987678','1','','$2a$10$W/Jh9aLcunw7wGAFa7GSuOcNroWzbk5Dy4AXPb7Ke85BIJdsEQNrC','0','0','127.0.0.1','2024-04-29 19:28:10','admin','2024-03-04 18:59:55','admin','2024-04-29 19:28:09',NULL,10000.00),(104,NULL,'zhouqi','zhouqi','00','','','0','','$2a$10$zrNOWMEs1CU3LCfmpOtfcO7MOEsjD2ABgWvvAO2pq7qg4TkdhuINS','0','2','',NULL,'','2024-04-28 15:31:06','',NULL,NULL,200.00);
...
INSERT INTO `sys_user_role` VALUES (1,1),(102,100),(103,101);
/*!40000 ALTER TABLE `sys_user_role` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'ry-etp'
--
...
-- Dump completed on 2024-04-29 22:40:13
