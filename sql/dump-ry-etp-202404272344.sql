...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='景点表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `etp_attractions` VALUES (1,'颐和园','北京','皇家园林',60,'/profile/upload/2024/04/26/IMG_20211205_121429_20240426211150A001.jpg');
...
CREATE TABLE `etp_reservation` (
  ...
  `reservation_status` tinyint DEFAULT NULL COMMENT '预约状态，0预约，1取消',
  PRIMARY KEY (`reservation_id`)
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='景点预约表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `etp_reservation` VALUES (26,1,1,'2024-04-28 09:00:00','2024-04-28 10:00:00',1),(27,1,1,'2024-04-28 09:00:00','2024-04-28 10:00:00',1),(28,1,1,'2024-04-28 10:00:00','2024-04-28 11:00:00',1),(29,1,1,'2024-04-28 09:00:00','2024-04-28 10:00:00',1),(30,1,1,'2024-04-28 13:00:00','2024-04-28 14:00:00',1),(31,1,1,'2024-04-28 15:00:00','2024-04-28 16:00:00',0);
...
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='购票记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `etp_ticket` VALUES (29,1,1,26,2,0,30.00,'2024-04-27 23:40:30',383.20);
...
) ENGINE=InnoDB AUTO_INCREMENT=173 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-04-27 23:44:32
