...
CREATE TABLE `etp_reservation` (
  ...
  `reservation_status` tinyint DEFAULT NULL COMMENT '预约状态，0预约，1取消',
  PRIMARY KEY (`reservation_id`)
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='景点预约表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `etp_reservation` VALUES (26,1,1,'2024-04-28 09:00:00','2024-04-28 10:00:00',1),(27,1,1,'2024-04-28 09:00:00','2024-04-28 10:00:00',1),(28,1,1,'2024-04-28 10:00:00','2024-04-28 11:00:00',1),(29,1,1,'2024-04-28 09:00:00','2024-04-28 10:00:00',1),(30,1,1,'2024-04-28 13:00:00','2024-04-28 14:00:00',1),(31,1,1,'2024-04-28 15:00:00','2024-04-28 16:00:00',0),(32,1,2,'2024-04-29 09:00:00','2024-04-29 10:00:00',0);
...
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='购票记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `etp_ticket` VALUES (29,1,26,26,2,1,30.00,'2024-04-27 23:40:30',383.20),(30,1,32,32,2,2,15.00,'2024-04-28 11:32:12',428.20);
...
) ENGINE=InnoDB AUTO_INCREMENT=177 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_role` VALUES (1,'超级管理员','admin',1,'1',1,1,'0','0','admin','2024-02-28 22:23:42','',NULL,'超级管理员'),(2,'教练员','coach',2,'2',0,1,'0','0','admin','2024-02-28 22:23:42','admin','2024-03-10 11:34:44','教练员'),(100,'VIP用户','VIP',3,'1',1,1,'0','0','admin','2024-02-28 22:41:12','admin','2024-03-10 11:35:10',NULL),(101,'普通用户','common',4,'1',1,1,'0','0','admin','2024-02-28 22:41:32','admin','2024-03-09 18:14:20','普通用户');
...
INSERT INTO `sys_role_menu` VALUES (2,2000),(2,2001),(2,2002),(2,2003),(2,2005),(2,2006),(2,2013),(2,2019),(2,2020),(2,2021),(100,2000),(100,2001),(100,2002),(100,2003),(100,2005),(100,2006),(100,2009),(100,2010),(100,2012),(100,2013),(100,2016),(100,2019),(100,2020),(100,2021),(100,2024),(100,2028),(101,2000),(101,2001),(101,2002),(101,2003),(101,2005),(101,2006),(101,2010),(101,2012),(101,2013),(101,2016),(101,2019),(101,2020),(101,2021);
...
INSERT INTO `sys_user_role` VALUES (1,1),(100,2),(101,2),(102,100),(103,101);
...
-- Dump completed on 2024-04-28 11:47:46
