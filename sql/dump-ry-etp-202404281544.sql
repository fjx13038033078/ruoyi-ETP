...
INSERT INTO `etp_attractions` VALUES (1,'颐和园','北京','皇家园林',60,'/profile/upload/2024/04/26/IMG_20211205_121429_20240426211150A001.jpg'),(2,'圆明园','北京市海淀区','皇家园林',30,'');
...
CREATE TABLE `etp_reservation` (
  ...
  `reservation_status` tinyint DEFAULT NULL COMMENT '预约状态，0预约，1取消',
  PRIMARY KEY (`reservation_id`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='景点预约表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `etp_reservation` VALUES (26,1,1,'2024-04-28 09:00:00','2024-04-28 10:00:00',1),(27,1,1,'2024-04-28 09:00:00','2024-04-28 10:00:00',1),(28,1,1,'2024-04-28 10:00:00','2024-04-28 11:00:00',1),(29,1,1,'2024-04-28 09:00:00','2024-04-28 10:00:00',1),(30,1,1,'2024-04-28 13:00:00','2024-04-28 14:00:00',1),(31,1,1,'2024-04-28 15:00:00','2024-04-28 16:00:00',0),(32,1,2,'2024-04-29 09:00:00','2024-04-29 10:00:00',0),(33,102,1,'2024-04-29 13:00:00','2024-04-29 14:00:00',0),(34,102,2,'2024-04-30 17:00:00','2024-04-30 18:00:00',0);
...
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='购票记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=188 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=206 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_role` VALUES (1,'超级管理员','admin',1,'1',1,1,'0','0','admin','2024-02-28 22:23:42','',NULL,'超级管理员'),(2,'教练员','coach',2,'2',0,1,'0','0','admin','2024-02-28 22:23:42','admin','2024-03-10 11:34:44','教练员'),(100,'优惠用户','VIP',3,'1',1,1,'0','0','admin','2024-02-28 22:41:12','admin','2024-04-28 15:00:33','老年人，儿童等可以优惠购票用户身份'),(101,'普通用户','common',4,'1',1,1,'0','0','admin','2024-02-28 22:41:32','admin','2024-04-28 15:00:42','普通用户');
...
INSERT INTO `sys_role_menu` VALUES (2,2000),(2,2001),(2,2002),(2,2003),(2,2005),(2,2006),(2,2013),(2,2019),(2,2020),(2,2021),(100,1),(100,107),(100,1035),(100,2031),(100,2032),(100,2033),(100,2034),(100,2036),(100,2037),(100,2040),(100,2041),(100,2042),(101,1),(101,107),(101,1035),(101,2031),(101,2032),(101,2033),(101,2034),(101,2036),(101,2037),(101,2040),(101,2041),(101,2042);
...
INSERT INTO `sys_user` VALUES (1,100,'admin','管理员','00','ry@163.com','15888888888','1','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','0','0','127.0.0.1','2024-04-28 15:31:29','admin','2024-02-28 22:23:42','','2024-04-28 15:31:29','管理员',578.20),(2,105,'ry','若依','00','ry@qq.com','15666666666','1','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','0','2','127.0.0.1','2024-02-28 22:23:42','admin','2024-02-28 22:23:42','',NULL,'测试员',NULL),(100,100,'zhangsan','张三','00','','13089876578','0','','$2a$10$g86PdbK5Z28hgOkGfevFCuO0KekkjR6OJdAHt8gCyLJFG3Uos.3JO','0','0','',NULL,'admin','2024-03-04 18:58:34','admin','2024-03-08 10:19:23',NULL,10.00),(101,100,'lisi','李四','00','','13909879876','0','','$2a$10$aiYx9RhkHXWto9AK.rMgu.MobzG6j76WtZ5jetHTmi67xJjcZ9tZq','0','0','',NULL,'admin','2024-03-04 18:58:57','admin','2024-03-08 10:19:28',NULL,10.00),(102,100,'wangwu','王五','00','','13809897654','1','','$2a$10$fvHIaJ0kOyCPYIFlo6Tnn.juTWodmgWP6IT/9D6qzI77zT6hhLNGS','0','0','127.0.0.1','2024-04-28 15:07:42','admin','2024-03-04 18:59:22','admin','2024-04-28 15:07:41',NULL,9556.80),(103,100,'zhaoliu','赵六','00','','13098987678','1','','$2a$10$W/Jh9aLcunw7wGAFa7GSuOcNroWzbk5Dy4AXPb7Ke85BIJdsEQNrC','0','0','127.0.0.1','2024-04-28 11:42:29','admin','2024-03-04 18:59:55','admin','2024-04-28 11:42:28',NULL,10000.00),(104,NULL,'zhouqi','zhouqi','00','','','0','','$2a$10$zrNOWMEs1CU3LCfmpOtfcO7MOEsjD2ABgWvvAO2pq7qg4TkdhuINS','0','0','',NULL,'','2024-04-28 15:31:06','',NULL,NULL,200.00);
...
-- Dump completed on 2024-04-28 15:44:52
